...
def command1():
    ...
    #output.pack() 
    hideframe() 
    theframe.grid(row=1,column=0,columnspan=4,rowspan=4,padx=10,pady=10)  

def command2():
    #output = Label(root, text="you click on preference")
    #output.pack()
    hideframe() 
    theframe2.grid(row=1,column=0,columnspan=4,rowspan=4,padx=10,pady=10)   
...
current_status.set("Status Bar")

status = Label(root, textvariable=current_status, bd=2, relief="sunken", width=182, anchor=E)
